...
class LikeControl: UIControl {
    ...
    private var unlikedImage = UIImage(systemName: "heart")?.withRenderingMode(.alwaysOriginal).withTintColor(.opaqueSeparator)
    ...
    func setupView() {
        ...
        button.setTitleColor(.opaqueSeparator, for: .normal)
